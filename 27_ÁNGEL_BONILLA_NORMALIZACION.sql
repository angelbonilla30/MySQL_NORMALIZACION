...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2021 a las 02:01:42
...
(2, 'Ordenes de alitas picantes', '2021-05-21', 1);
...
(1, 'Factura de ordenes de alitas', '2021-05-21', 1);
...
INSERT INTO `tbl_pedidos` (`ID_PEDIDOS`, `DESCRIPCION_PEDIDO`, `FECHA`, `ID_DIRECCION`) VALUES
(1, 'Seis ordenes de alitas picantes', '2021-05-21', 1);
...
ALTER TABLE `tbl_pedidos`
  ...
  ADD KEY `TK_DIRECCIONES_PEDIDOS` (`ID_DIRECCION`);
